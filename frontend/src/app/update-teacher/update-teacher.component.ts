...
export class UpdateTeacherComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,private service:ApplicationService, private route:Router,private _Activatedroute:ActivatedRoute) {
...
this.formGroup.patchValue({
  ...
  onSubmit(teacher:any) {
    this.spinner=true;
    this.service.updateTeacher(this.currentTeacher.teacher_ID,teacher).subscribe(res=>{
